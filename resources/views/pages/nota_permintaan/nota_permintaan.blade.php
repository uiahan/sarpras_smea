    ...
    <div class="d-flex">
        ...
        <div class="container mt-4 mt-md-5 py-5">
            <div class="p-4 shadow card border-0">
                <div class="row">
                    <div class="col-6">
                        <h3 class="fw-bold text-secondary">Nota Permintaan</h3>
                    </div>
                    <div class="col-6">
                        <p class="text-muted text-xl-end text-secondary">Nota Permintaan &gt; Home</p>
                    </div>
                </div>
            </div>
            ...
            <div class="card card-nasabah count-card border-0 mt-4 shadow" style="background-color: #d9261c">
                <div class="row px-3 py-4">
                    <div class="col-7 text-white">
                        <h5>Nota Permintaan:</h5>
                        <h1 class="px-3">{{ $notaPermintaanCount }}</h1>
                    </div>
                    <div class="col-5 d-flex align-items-center" style="height: 100%;">
                        <i class='fa-solid fa-note-sticky nav_icon text-white' style="font-size: 5rem"></i>
                    </div>
                </div>
            </div>
            ...
            <div class="card border-0 mt-4 p-4 shadow">
                <div class="row">
                    <div class="col-md-3">
                        <h4 class="me-auto text-secondary">Tabel Nota Permintaan</h4>
                    </div>
                </div>
                <hr>
                <form action="{{ route('nomorVerifikasi') }}" method="GET">
                    <div class="row">
                        ...
                        <tbody style="background-color: #f2f2f2">
                            ...
                            <tr>
                                ...
                                <td style="vertical-align: middle;">
                                    <div class="d-flex">
                                        @if (!$item->nomor_verifikasi)
                                        <a href="{{ route('verifikasi', $item->nomor_permintaan) }}" class="btn btn-success ms-1"
                                    ...
                                    @endif
                                        ...
                                        <a href="{{ route('downloadNomorVerifikasiExcel', $item->nomor_permintaan) }}"
