    ...
    <div class="d-flex">
        ...
        <div class="container mt-4 mt-md-5 py-5">
            <div class="p-4 shadow card border-0">
                <div class="row">
                    <div class="col-6">
                        <h3 class="fw-bold text-secondary">Verifikasi</h3>
                    </div>
                    <div class="col-6">
                        <p class="text-muted text-end text-secondary">Nota Permintaan &gt; Verifikasi</p>
                    </div>
                </div>
            </div>

            <div class="card border-0 mt-4 p-4 shadow">
                <h4 class=" text-secondary">Data Verifikasi</h4>
                <hr>
                <form action="{{ route('postVerifikasi', $nomor_permintaan) }}" method="POST" enctype="multipart/form-data"
                    class="form-group">
                    @csrf
                    <div class="row">
                        <div class="col-12">
                            <div>
                                <label for="nomor_verifikasi" class="form-label">Nomor Verifikasi</label>
                                <input type="text" id="nomor_verifikasi" name="nomor_verifikasi" class="form-control border-0"
                                    style="background-color: #ededed" placeholder="masukan nomor verifikasi" required>
                            </div>
                        </div>
                        <div>
