            ...
            <div class="p-4 shadow card border-0">
                <div class="row">
                    <div class="col-xl-6 col-12">
                        <h3 class="fw-bold text-secondary">Edit Sumber Dana</h3>
                    </div>
                    <div class="col-xl-6 col-12">
                        <p class="text-muted text-xl-end text-secondary">Dana &gt; Edit</p>
                    </div>
                </div>
            </div>

            <div class="card border-0 mt-4 p-4 shadow">
                <h4 class=" text-secondary">Data Sumber Dana</h4>
                <hr>
                <form action="{{ route('postEditDana', $dana->id) }}" method="POST" enctype="multipart/form-data"
                    class="form-group">
                    @csrf
                    <div class="row">
                        <div class="col-12">
                            <div>
                                ...
                                <input type="text" id="sumber_dana" name="sumber_dana" class="form-control border-0"
                                    style="background-color: #ededed" value="{{ $dana->sumber_dana }}" placeholder="masukan nama jurusan" required>
                            </div>
                        </div>
