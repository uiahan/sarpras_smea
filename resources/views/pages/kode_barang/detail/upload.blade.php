        ...
        <div class="container mt-4 mt-md-5 py-5">
            <div class="p-4 shadow card border-0">
                <div class="row">
                    ...
                    <div class="col-6">
                        <p class="text-muted text-xl-end text-secondary">Detail Kode Barang &gt; Upload Excel</p>
                    </div>
                </div>
            </div>
            ...
            <div class="card border-0 mt-4 p-4 shadow">
                ...
                <hr>
                <form action="{{ route('uploadDetailKodeBarangExcel', $kode_barang_id) }}" method="POST" enctype="multipart/form-data"
                    class="form-group">
                    @csrf
                    <div class="row">
                        <div class="col-12">
