...
@section('title', 'Edit Detail Kode Barang')
@section('content')
    <div class="d-flex">
        ...
        <div class="container mt-4 mt-md-5 py-5">
            <div class="p-4 shadow card border-0">
                <div class="row">
                    <div class="col-xl-6 col-12">
                        <h3 class="fw-bold text-secondary">Edit Detail Kode Barang</h3>
                    </div>
                    <div class="col-xl-6 col-12">
                        <p class="text-muted text-xl-end text-secondary">Detail Kode Barang &gt; Edit</p>
                    </div>
                </div>
            </div>
            ...
            <div class="card border-0 mt-4 p-4 shadow">
                ...
                <hr>
                <form action="{{ route('postEditDetailBarang', $detailKodeBarang->id) }}" method="POST" enctype="multipart/form-data"
                    class="form-group">
                    @csrf
                    <div class="row">
                        <div class="col-12">
                            <div>
                                ...
                                <input type="text" id="nusp" value="{{ $detailKodeBarang->nusp }}" name="nusp" class="form-control border-0"
                        ...
                        <div class="col-12 mt-3">
                            <div>
                                ...
                                <input type="text" value="{{ $detailKodeBarang->nama_barang }}" id="nama_barang" name="nama_barang" class="form-control border-0"
