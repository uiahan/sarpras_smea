...
@section('title', 'Detail Kode Barang')
@section('content')
    <div class="d-flex">
        ...
        <div class="container mt-4 mt-md-5 py-5">
            <div class="p-4 shadow card border-0">
                <div class="row">
                    <div class="col-6">
                        <h3 class="fw-bold text-secondary">Detail Kode Barang</h3>
                    </div>
                    <div class="col-6">
                        <p class="text-muted text-end text-secondary">Detail Kode Barang &gt; Home</p>
                    </div>
                </div>
            </div>
            ...
            <div class="card border-0 mt-4 p-4 shadow">
                <div class="row">
                    <div class="col-md-3">
                        <h4 class="me-auto text-secondary">Detail Barang {{ $kodeBarang->kode_barang }}</h4>
                    </div>
                    <div class="col-md-9 d-flex justify-content-end d-none d-xl-block">
                        <div class="d-flex justify-content-end">
                            <a href="{{ route('tambahDetailKodeBarang') }}" class="btn mt-3 rounded-4 text-white btn-kuning"
                            style="background-color: #edbb05">
                            <i class="fa-solid fa-plus"></i> Tambah Detail
                        </a>
                            <a href="{{ route('uploadDetailKodeBarangExcelShow') }}" class="btn btn-success mt-3 rounded-4 ms-2 text-white">
                                <i class="fa-solid fa-file-excel"></i> Upload Excel
                            </a>
                            <a href="{{ route('downloadExcelDetailKodeBarang', $kodeBarang->id) }}" class="btn mt-3 rounded-4 ms-2 text-white btn-primary">
                                <i class="fa-solid fa-file-excel"></i> Download Excel
                            </a>
                            <a href="{{ route('kodeBarang') }}" class="btn mt-3 rounded-4 ms-2 text-white btn-merah" style="background-color: #d9261c">
                    ...
                    <div class="col-md-12 d-block d-xl-none">
                        <div>
                            <a href="{{ route('tambahKodeBarang') }}" class="btn w-100 rounded-4 text-white btn-kuning"
                                style="background-color: #edbb05">
                                <i class="me-1 fa-solid fa-plus"></i> Tambah Detail
                            </a>
                            <a href="{{ route('uploadDetailKodeBarangExcelShow') }}" class="btn btn-success mt-3 w-100 rounded-4 text-white">
                                <i class="fa-solid fa-file-excel"></i> Upload Excel
                            </a>
                            <a href="{{ route('downloadExcelDetailKodeBarang', $kodeBarang->id) }}" class="btn mt-3 w-100 rounded-4 text-white btn-primary">
                                <i class="fa-solid fa-file-excel"></i> Download Excel
                            </a>
                        </div>
                    </div>
                            ...
                            @foreach ($detailKodeBarang as $item)
                                <tr>
                                    ...
                                    <td style="vertical-align: middle;">
                                        <div class="d-flex">
                                            <a href="{{ route('editDetailKodeBarang', $item->id) }}" class="btn btn-success"
                                                style="padding: 12px 15px;">
                                                <i class="fa-solid fa-pen-to-square"></i>
                                            </a>
                                            <a href="{{ route('postHapusDetailBarang', $item->id) }}" class="btn text-white ms-1 btn-merah" onclick="return confirm('Apakah Anda yakin ingin menghapus data ini?');"
