    ...
    <div class="d-flex">
        ...
        <div class="container mt-4 mt-md-5 py-5">
            <div class="p-4 shadow card border-0">
                <div class="row">
                    <div class="col-6">
                        <h3 class="fw-bold text-secondary">Surat Permintaan</h3>
                    </div>
                    <div class="col-6">
                        <p class="text-muted text-xl-end text-secondary">Surat Permintaan &gt; Home</p>
                    </div>
                </div>
            </div>
            ...
            <div class="card card-nasabah count-card border-0 mt-4 shadow" style="background-color: #d9261c">
                <div class="row px-3 py-4">
                    <div class="col-7 text-white">
                        ...
                        <h1 class="px-3">{{ $suratPermintaanCount }}</h1>
                    </div>
                    <div class="col-5 d-flex align-items-center" style="height: 100%;">
                        <i class='fa-solid fa-envelope nav_icon text-white' style="font-size: 5rem"></i>
                    </div>
                </div>
            </div>
            ...
            <div class="card border-0 mt-4 p-4 shadow">
                <div class="row">
                    <div class="col-md-3">
                        <h4 class="me-auto text-secondary">Tabel Surat Permintaan</h4>
                    </div>
                </div>
                <hr>
                <form action="{{ route('suratPermintaan') }}" method="GET">
                    <div class="row">
                    ...
                    <table class="table" id="example">
                        ...
                        <tbody style="background-color: #f2f2f2">
                            ...
                            <tr>
                                ...
                                <td style="vertical-align: middle;">
                                    <div class="d-flex">
                                        <a href="{{ route('detailSuratPermintaan', $item->nomor_verifikasi) }}" class="btn ms-1 btn-primary"
                                            style="padding: 12px 15px;">
                                            <i class="fa-regular fa-eye"></i>
                                        </a>
                                        <a href="{{ route('downloadSuratPermintaan', $item->nomor_verifikasi) }}"
