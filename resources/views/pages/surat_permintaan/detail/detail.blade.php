...
@section('title', 'Detail Surat Permintaan')
@section('content')
    <div class="d-flex">
        ...
        <div class="container mt-4 mt-md-5 py-5">
            <div class="p-4 shadow card border-0">
                <div class="row">
                    <div class="col-6">
                        <h3 class="fw-bold text-secondary">Detail Surat Permintaan</h3>
                    </div>
                    <div class="col-6">
                        <p class="text-muted text-xl-end text-secondary">Surat Permintaan &gt; Detail</p>
                    </div>
                </div>
            </div>
                ...
                <div class="row">
                    ...
                    <div class="col-md-8 d-flex justify-content-end d-none d-xl-block">
                        <div class="d-flex justify-content-end">
                            <a href="{{ route('suratPermintaan') }}" class="btn ms-2 rounded-4 text-white btn-kuning"
                    ...
                    <div class="col-md-12 d-block d-xl-none">
                        <div>
                            <a href="{{ route('suratPermintaan') }}" class="btn mt-3 w-100 rounded-4 text-white btn-kuning"
                                style="background-color: #edbb05">
                                Kembali <i class="fa-solid fa-arrow-right ms-1"></i>
                            </a>
                        </div>
                    ...
                    <table class="table table-bordered" id="example">
                        <thead style="background-color: #f2f2f2">
                            <tr>
                                ...
                                <th rowspan="2" style="vertical-align: middle; text-align:center;">NUSP</th>
                                ...
                                <th colspan="2" style="vertical-align: middle; text-align:center;">Usulan Pengajuan Persetujuan</th>
                                <th rowspan="2" style="vertical-align: middle; text-align:center;">Keperluan</th>
                            ...
                            @foreach ($pengajuan as $item)
                                <tr>
                                    ...
                                    <td style="vertical-align: middle;">
                                        @if ($item->jumlah_yg_diacc)
                                            {{ $item->jumlah_yg_diacc }}
                                        @else
                                    ...
                                    <td style="vertical-align: middle;"><a href="{{ route('editDetailSuratPermintaan', $item->id) }}"
