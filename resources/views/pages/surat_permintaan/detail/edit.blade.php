    ...
    <div class="d-flex">
        ...
        <div class="container mt-4 mt-md-5 py-5">
            <div class="p-4 shadow card border-0">
                <div class="row">
                    <div class="col-6">
                        <h3 class="fw-bold text-secondary">Edit Detail</h3>
                    </div>
                    <div class="col-6">
                        <p class="text-muted text-end text-secondary">Surat Permintaan &gt; Detail &gt; Edit</p>
                    </div>
                </div>
            </div>

            <div class="card border-0 mt-4 p-4 shadow">
                <h4 class=" text-secondary">Data Detail Surat Permintaan</h4>
                <hr>
                <form action="{{ route('postEditDetailSuratPermintaan', $pengajuan->id) }}" method="POST" enctype="multipart/form-data"
                    class="form-group">
                    @csrf
                    <div class="row">
                        <div class="col-12">
                            <div>
                                <label for="jumlah_yg_diacc" class="form-label">Jumlah Barang Yang Di Acc*</label>
                                <input type="text" id="jumlah_yg_diacc" name="jumlah_yg_diacc" class="form-control border-0"
                                    style="background-color: #ededed" value="{{ $pengajuan->jumlah_yg_diacc }}" placeholder="masukan jumlah barang yang akan di acc" required>
                            </div>
                        </div>
                        <div>
