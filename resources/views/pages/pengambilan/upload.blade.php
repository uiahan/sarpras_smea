    ...
    <div class="d-flex">
        ...
        <div class="container mt-4 mt-md-5 py-5">
            <div class="p-4 shadow card border-0">
                <div class="row">
                    <div class="col-6">
                        <h3 class="fw-bold text-secondary">Upload Pengambilan</h3>
                    </div>
                    <div class="col-6">
                        <p class="text-muted text-end text-secondary">Pengambilan &gt; Upload</p>
                    </div>
                </div>
            </div>

            <div class="card border-0 mt-4 p-4 shadow">
                <h4 class=" text-secondary">Data Pengambilan</h4>
                <hr>
                <form action="{{ route('uploadFilePengambilan') }}" method="POST" enctype="multipart/form-data" class="form-group">
                    @csrf
                    <div class="row">
                        <div class="col-12">
                            <div>
                                <label for="upload_pengambilan_file" class="form-label">File Pengambilan</label>
                                <input type="file" id="upload_pengambilan_file" name="upload_pengambilan_file"
                        ...
                        <div>
                            ...
                            <a class="btn text-white mt-3 btn-kuning ms-1 btn-merah" href="{{ route('pengambilan') }}"
