    ...
    <div class="d-flex">
        ...
        <div class="container mt-4 mt-md-5 py-5">
            <div class="p-4 shadow card border-0">
                <div class="row">
                    <div class="col-6">
                        <h3 class="fw-bold text-secondary">Dokumen</h3>
                    </div>
                    <div class="col-6">
                        <p class="text-muted text-end text-secondary">Dokumen &gt; Home</p>
                    </div>
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-xl-4 col-12">
                    <div class="card w-100 card-nasabah count-card border-0 mt-4 shadow" style="background-color: #d9261c">
            ...
            <div class="card border-0 mt-4 p-4 shadow">
                <div class="row">
                    <div class="col-md-4">
                        <h4 class="me-auto text-secondary">Tabel Dokumen Pengajuan
                    </div>
                </div>
                <hr>
                                        ...
                                        @if ($item->uploads->isNotEmpty())
                                            @foreach ($item->uploads as $upload)
                                                <p class="text-success">
                                                    {{-- Batasi panjang nama file dengan limit() --}}
                                                    {{ \Illuminate\Support\Str::limit(basename($upload->upload_pengajuan_file), 30) }}
                                                </p>
                                            @endforeach
                                        @else
                                            <p class="text-danger">
                                                Belum upload dokumen pengajuan
                                            </p>
                                        @endif
                                    </td>
