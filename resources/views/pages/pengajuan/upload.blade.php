    ...
    <div class="d-flex">
        ...
        <div class="container mt-4 mt-md-5 py-5">
            <div class="p-4 shadow card border-0">
                <div class="row">
                    <div class="col-xl-6">
                        <h3 class="fw-bold text-secondary">Upload Pengajuan</h3>
                    </div>
                    <div class="col-6">
                        <p class="text-muted text-xl-end text-secondary">Pengajuan &gt; Upload</p>
                    </div>
                </div>
            </div>
            ...
            <div class="card border-0 mt-4 p-4 shadow">
                ...
                <hr>
                <form action="{{ route('uploadFile') }}" method="POST" enctype="multipart/form-data" class="form-group">
                    @csrf
                    <div class="row">
                        <div class="col-12">
                            <div>
                                <label for="upload_pengajuan_file" class="form-label">File Pengajuan</label>
                                <input type="file" id="upload_pengajuan_file" name="upload_pengajuan_file"
                                    class="form-control border-0" style="background-color: #ededed"
                                    placeholder="masukan file pengajuan" required>
                            </div>
                        </div>
                        <div>
